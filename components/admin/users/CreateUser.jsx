...
export default function CreateUser({ vendorsData }) {
    const [vendors, setVendors] = useState(vendorsData); // Vendors list for the dropdown
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border ${formData.userType === 'warehouse' ? 'bg-gray-100' : 'bg-white'
