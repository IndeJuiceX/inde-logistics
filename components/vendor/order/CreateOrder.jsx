...
export default function CreateOrder({ vendorId }) {
        ...
        if (file) {
            ...
            reader.onload = (event) => {
                try {
                    ...
                    if (Array.isArray(parsedData.orders) && parsedData.orders.length > 0) {
    ...
    const handleUploadOrders = async () => {
        ...
        const confirmed = confirm('Are you sure you want to upload the orders?');
        if (!confirmed) return;
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(`Failed to upload orders: ${result.error}`);
            }
        } catch (error) {
    ...
    const breadCrumbLinks = [
        ...
        { text: 'Order', url: `/vendor/${vendorId}/orders` },
        { text: 'Upload Orders' }
    ];
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-100 py-10">
                <div className="container mx-auto px-4">
                    <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">Upload Orders</h1>

                    {/* File Upload Section */}
                    <div className="bg-white shadow-md rounded-lg p-6 mb-6">
                        <h2 className="text-xl font-semibold text-gray-800 mb-4">Select Order JSON File</h2>
                        <input
                            type="file"
                            accept=".json"
                    ...
                    {uploadResult && (
                        <div className="bg-white shadow-md rounded-lg p-6">
                            ...
                            <p className="text-gray-600 mb-2">
                                <strong>Total Items:</strong> {selectedFile?.orders?.length || 0}
                            </p>
                            <p className="text-gray-600 mb-2">
                            ...
                            {uploadResult.invalidItems && (
                                <div className="mt-4">
                                    <h3 className="text-lg font-semibold text-red-600">Invalid Orders:</h3>
