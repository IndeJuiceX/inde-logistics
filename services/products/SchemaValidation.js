...
class SchemaValidation {
    ...
    static getStockShipmentItemSchema() {
        return Joi.object({
            vendor_sku: Joi.string().required().label('vendor_sku'),
    ...
    static validateStockShipmentItem(item) {
        const schema = this.getStockShipmentItemSchema();
    ...
    static validateStockShipmentItems(items) {
        const validatedItems = [];
        const invalidItems = [];

        items.forEach((item) => {
            const result = this.validateStockShipmentItem(item);
            if (result.success) {
    ...
    static getVendorSkuArraySchema() {
        return Joi.array()
    ...
    static validateVendorSkuArray(items) {
        const schema = this.getVendorSkuArraySchema();
